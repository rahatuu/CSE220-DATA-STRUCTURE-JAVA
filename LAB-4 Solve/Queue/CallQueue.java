...
class CallQueue {
    ...
    public void dequeueCall() {
      if (vipQueue.isEmpty()==false) {
        int vipCustomer = vipQueue.dequeue();
        System.out.println("Processing VIP Customer " + vipCustomer + ".");}
      else if (regularQueue.isEmpty()==false) {
        int regularCustomer = regularQueue.dequeue();
        System.out.println("Processing Regular Customer " + regularCustomer + ".");}
      else {
